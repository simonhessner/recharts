...
declare class Scatter extends PureComponent<Props, State> {
    ...
    static getComposedData: ({ xAxis, yAxis, zAxis, item, displayedData, onItemMouseLeave, onItemMouseEnter, onItemClick, xAxisTicks, yAxisTicks, offset, }: {
        props: Props;
        xAxis: Pick<XAxisProps, "height" | "name" | "type" | "width" | "orientation" | "label" | "dataKey" | "ticks" | "hide" | "tick" | "tickCount" | "axisLine" | "tickLine" | "tickSize" | "tickFormatter" | "allowDataOverflow" | "allowDuplicatedCategory" | "allowDecimals" | "domain" | "unit" | "axisType" | "range" | "AxisComp" | "padding" | "xAxisId" | "mirror" | "minTickGap" | "interval" | "reversed"> & {
            scale: D3Scale<React.ReactText>;
        };
        yAxis: Pick<YAxisProps, "height" | "name" | "type" | "width" | "orientation" | "label" | "dataKey" | "ticks" | "hide" | "tick" | "tickCount" | "axisLine" | "tickLine" | "tickSize" | "tickFormatter" | "allowDataOverflow" | "allowDuplicatedCategory" | "allowDecimals" | "domain" | "unit" | "axisType" | "range" | "AxisComp" | "padding" | "mirror" | "minTickGap" | "interval" | "reversed" | "yAxisId"> & {
            scale: D3Scale<React.ReactText>;
        };
